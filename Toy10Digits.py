...
#%% Parameters to tune
######################################################################################
printout_dir = "sim_printouts/Toy10Digits/"
sheet_dir = "sim_printouts/Toy10Digits/ConnectivityTable.xlsx"
...
if decaying_current:
    ...
    vth_hidden = 14             # with 3-spike consideration: [(3-1) x 5, 3 x 5]
    vth_output = 38             # with 8-spike consideration: [(8-1) x 5, 8 x 5]
